...
URL.createObjectURL() is a built-in JavaScript method that creates a temporary local URL (a “blob URL”) which represents a file or binary object stored in memory. */}
          <label htmlFor="image">
            {image ? (
              <img
