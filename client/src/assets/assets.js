...
export const dummyUserData = {
  ...
  full_name: "Asif Shaikh",
  username: "asif_shaikh",
...
export const dummyStoriesData = [
  ...
  /* 
      is an ISO 8601 timestamp in UTC (Coordinated Universal Time).
      2025-10-25 → Date → 25th October 2025
      08:16:06.958 → Time → 8 hours, 16 minutes, 6 seconds, and 958      milliseconds
      Z → Means Zulu time, another name for UTC (no timezone offset)
      So it represents:
      October 25, 2025, at 08:16:06.958 AM (UTC).
    */
  {
