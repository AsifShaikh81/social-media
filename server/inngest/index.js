...
export const functions = [syncUserCreation,syncUserUpdation,syncUserDeletion, sendNewConnectionRequestReminder, sendNotificationOfUnseenMessages, deleteStory];